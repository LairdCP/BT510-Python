...
"""
Connect to a sensor and set its clock (pseudo-rtc).
Laird Connectivity BT510 uses seconds from 1970 (an unsigned 32-bit number).
"""
            ...
            if ap is not None:
                if ap.adv_valid:
                    ...
                    if ap.bd_addr not in configured_devices:
                        ...
                        logging.debug("Preparing to set Epoch")
